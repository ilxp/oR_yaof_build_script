...
merge_package master https://github.com/QiuSimons/OpenWrt-Add.git package/new nft-fullcone openwrt_helloworld/xray-core openwrt_helloworld/v2ray-core openwrt_helloworld/v2ray-geodata openwrt_helloworld/sing-box luci-app-frps luci-app-frpc imm_pkg/frp openwrt_helloworld/microsocks openwrt_helloworld/shadowsocks-libev openwrt_pkgs/coremark
...
cp -f ./diydata/PATCH/pkgs/odhcpd/0001-odhcpd-improve-RFC-9096-compliance.patch ./package/network/services/odhcpd/patches/0001-odhcpd-improve-RFC-9096-compliance.patch
